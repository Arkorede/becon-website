...
const Minister = () => {
  return (
    <section className="">
      {/* min-[604px]:h-[46rem] min-[606px]:h-[46rem] min-[670px]:h-[50rem] */}
      <div className="relative h-[45rem] min-[630px]:h-[48rem] min-[680px]:h-[50rem] min-[768px]:h-auto md:pl-24 lg:pl-32 mt-[3.75rem]">
        <Tabs>
          <TabPanel>
